...
import { ArchitectureAnalyzerService } from "@/modules/analysis/ArchitectureAnalyzerService";
...
function buildService() {
  ...
  return new ArchitectureAnalyzerService(completion);
}
...
export async function POST(
  ...
  try {
    ...
    const report = await service.analyze(repositoryId);
